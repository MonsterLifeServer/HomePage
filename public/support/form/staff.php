    ...
    <body class="form_page">
            ...
            <div class="mainBox">
                <div class="contents">
                    ...
                    <form method="post" action="" name="input">
                        ...
                        <h5>免責事項</h5>
                        <div id="mennseki">
                            <p>当鯖は、ボランティア活動となり定期的な報酬の見込みがありません。こちらが提示している役職以外にも「こんな役職は？」というものを受け付けています。その場合は その他 を選んで役職の内容は 自由記入欄 にお書きください。</p>
                        </div>
        ...
        <script>
            ...
            var textArray = new Array(
                '',
                '<p>当鯖は、ボランティア活動となり定期的な報酬の見込みがありません。運営は重要役職との兼業が必須となります。重要役職は 開発者(Plugin/Skript)と動画編集者です。</p>',
            ...
            var elseText = '<p>当鯖は、ボランティア活動となり定期的な報酬の見込みがありません。こちらが提示している役職以外にも「こんな役職は？」というものを受け付けています。その場合は その他 を選んで役職の内容は 自由記入欄 にお書きください。</p>';
