            ...
            <div class="mainBox">
                <div class="contents">
                    ...
                    <div class="box text-left">
						<ul>
                            <li>非対称型対戦ゲーム『DeadbyDaylight』をマイクラで再現したミニゲームやPCゲーム『青鬼』の館をマイクラで再現した鬼ごっこ型のミニゲームやスマホゲーム『青鬼ONLINE』をマイクラで再現したミニゲーム，増え鬼などあらゆるミニゲーム企画を開催・現在進行形で開発しております。当鯖に参加して遊べるミニゲームは<a href="<?php echo $func->getUrl(); ?>/game/" target="_blank">ミニゲーム一覧</a>より確認できます。</li>
